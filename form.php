...
<div class="container-fluid title-container">
  ...
  <a href="#x-popup">  <button class="btn btn-sm btn-outline-secondary second-button sp-button" type="button">Zoho Creator App</button></a>
    <button class="btn btn-sm btn-outline-secondary second-button sp-button" type="button"><i class="fa-solid fa-clipboard-list clipboard"></i></button>
...
<div class="container-fluid middle-container">
  ...
  <nav class="navbar  request-nav">
     <div class="container-fluid">
    <form class="container-fluid justify-content-start   ">
<a href="index.php" class="btn req-button">
...
<form class="form-fill" action="#" method="POST">
  <div class="row">
    <div class="col-4">
      ...
      <input type="text" class="form-control mb-2" id="inlineFormInput" placeholder="Your name" name="rname" required>
    </div>
  ...
  <div class="row">
      <div class="col-7">
        ...
        <input type="text" class="form-control mb-2 " id="inlineFormInput" placeholder="" name="subject" required>
      ...
      <div class="form-group col-lg-4 status">
        ...
        <select id="inputState" class="form-control" name="department" required>
          ...
          <option value="Cardiac OT">Cardiac OT</option>
          <option value="CEO office">CEO office</option>
          <option value="Chemotherapy">Chemotherapy</option>
          <option value="Dialysis">Dialysis</option>
          <option value="ECG">ECG</option>
          <option value="FortisINN">FortisINN</option>
        ...
        <div class="row">
            <div class="col-4">
              ...
              <select id="inputState" class="form-control" name="assigned" required>
                <option value="">Select..</option>
                <option value="Fortis Amritsar">Fortis Amritsar</option>
                <option value="Fortis Arcot">Fortis Arcot</option>
                <option value="Fortis Bangalore">Fortis Bangalore</option>
                <option value="Fortis Dehradun">Fortis Dehradun</option>
                <option value="Fortis Faridabad">Fortis Faridabad</option>
                <option value="Fortis GGN-FMRI">Fortis GGN-FMRI</option>
                <option value="Fortis Jaipur">Fortis Jaipur</option>
                <option value="Fortis Noida">Fortis Noida</option>
            </select>
            </div>
...
<nav class="navbar fixed-bottom navbar-light  bottom-nav " >
  ...
  <input type="submit" name="register" value="Add Request" class="btn submit-button">
...
if($_POST['register'])
{
    ...
    $query = "INSERT INTO client (rname,rtype,subject,department,assigned,status,priority)
    values('$rname','$rtype','$subject','$department','$assigned','$status','$priority')";
