      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item home">
            <a class="nav-link ho " aria-current="page" href="index.php">Home</a>
          </li>
          <li class="nav-item dash">
            <a class="nav-link da" href="dash.html">Dashboard</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link " href="form.php"><i class="fa-solid fa-hand"></i></a>
    ...
    <div class="dashboard-cards">
                   ...
                   <div class="card"  id="card-2">
                       <div class="chart-canvas">
                           ...
                           <canvas id="ExpensesByType"></canvas>
                   ...
                   <div class="card"  id="card-3">
                       <div class="chart-canvas">
                           <canvas id="ExpensesByTicketStatus"></canvas>
                       </div>
                   </div>
