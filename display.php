...
<img class="ibm" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSh4rUVWDMjjaWBg4Z-GPl7e2d3gXJ6QcpcKQ&usqp=CAU" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item requests">
            <a class="nav-link re" href="#">Requests</a>
          </li>
  ...
  <a href="#x-popup"><button class="btn btn-sm btn-outline-secondary second-button" type="button">Zoho Creator App</button></a>
      <button class="btn btn-sm btn-outline-secondary second-button" type="button"><i class="fa-solid fa-clipboard-list clipboard"></i></button>
...
<h3>Request List</h3>
    ...
    error_reporting(0);
      ...
      $query = "select * from client ORDER BY Request_id desc";
      ...
      if($total != 0)
      {
            ...
            <table border="3"  cellspacing="5" width="100%" >
              <tr>
              <th width="3%">Request ID</th>
              <th width="10%">Requester</th>
              <th width="7%">Request type</th>
      ...
      while ($result = mysqli_fetch_assoc($data))
       {
         echo "<tr>
                  ...
                  <td><a href='update.php?id=$result[Request_id]'><input type='submit' value='Update' class='up-button'></a>
    <a href='delete.php?id=$result[Request_id]'><input type='submit' value='Delete' class='del-button' onclick = 'return ch_delete()' ></a></td>
